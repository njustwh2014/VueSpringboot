    ...
    <div class="me-login-box me-login-box-radius">
      ...
      <el-form ref="user" :model="user" :rules="rules" status-icon>
        ...
        <el-form-item prop="password">
          <el-input type="password" placeholder="新密码" v-model= "user.password" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item size="small" class="me-login-button">
          ...
          <el-button type="primary" icon="el-icon-upload" @click="getbackaccount('capture')">确认找回</el-button>
        </el-form-item>
      </el-form>
      ...
      getbackaccount(capture){
        if(captchaflag){
          ...
          if(this.capture.code!=randomCode){
            ...
            let that=this
          that.$store.dispatch('getbackaccount',that.user).then(()=>{
            this.$message("找回成功")
